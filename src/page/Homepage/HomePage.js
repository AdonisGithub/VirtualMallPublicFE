            ...
            <div className="w-full py-2 text-white">
              <div className="w-[229px] lg:w-[300px] 2xl:w-[530px] ml-[5%] xs:ml-[15%] max-w-[95%] xs:max-w-[85%]">
                ...
                <div className="w-full flex gap-[18px]">
                  <button
                    className="w-[216px] h-9 2xl:h-[48px] flex items-center justify-center text-base border border-transparent hover:border-gray-200  bg-[#ff0000] hover:bg-transparent rounded-md active:border-[#ff0000] active:text-[#ff0000]"
                    onClick={signinClick}
                  >
                    Sign In
                  </button>
